...
//   let str = "20";
// let a = 5;
// document.write(str + a + "<br/>"); // 205 тут відбувається конкатинація приведення то строки через + в інших випадках все приведеться до числа
...
// let sur = prompt('surname');
// let age = prompt('age');
// alert(`Доброго вечера ${name} ${sur}, мои поздравления что вам ${age}`);
//
// =====================
// ======ДОП============
// =====================
